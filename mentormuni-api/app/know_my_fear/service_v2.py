...
class PrivateKnowMeService:
    ...
    async def generate_insight(
        ...
        heuristic = _heuristic_insight(responses_by_key, user.first_name or "friend")
        ...
        try:
            ...
            payload = _parse_insight_json(content, fallback_heuristic=heuristic)
...
def _heuristic_insight(responses: dict[str, dict], name: str = "friend") -> PrivateInsightOut:
...
def _parse_insight_json(content: str, fallback_heuristic: PrivateInsightOut) -> PrivateInsightOut:
